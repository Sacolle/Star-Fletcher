...
ATTRIBUTE FP cross_deriv_neg_neg(
...
ATTRIBUTE FP cross_deriv_neg_pos(
    const FP* block, const size_t base_idx,
    const size_t dir1, const FP* block_neg_center, const FP* block_pos_center, const int stride1,
    const size_t dir2, const FP* block_center_neg, const FP* block_center_pos, const int stride2,
    const FP* block_pos_pos, const FP* block_pos_neg, 
...
ATTRIBUTE FP cross_deriv_neg_center(
    const FP* block, const size_t base_idx,
    const size_t dir1, const FP* block_neg_center, const FP* block_pos_center, const int stride1,
    const size_t dir2, const FP* block_center_neg, const FP* block_center_pos, const int stride2,
    const FP* block_pos_pos, const FP* block_pos_neg, 
...
ATTRIBUTE FP cross_deriv_pos_neg(
    const FP* block, const size_t base_idx,
    const size_t dir1, const FP* block_neg_center, const FP* block_pos_center, const int stride1,
    const size_t dir2, const FP* block_center_neg, const FP* block_center_pos, const int stride2,
    const FP* block_pos_pos, const FP* block_pos_neg, 
...
ATTRIBUTE FP cross_deriv_pos_pos(
    const FP* block, const size_t base_idx,
    const size_t dir1, const FP* block_neg_center, const FP* block_pos_center, const int stride1,
    const size_t dir2, const FP* block_center_neg, const FP* block_center_pos, const int stride2,
    const FP* block_pos_pos, const FP* block_pos_neg, 
...
ATTRIBUTE FP cross_deriv_pos_center(
    const FP* block, const size_t base_idx,
    const size_t dir1, const FP* block_neg_center, const FP* block_pos_center, const int stride1,
    const size_t dir2, const FP* block_center_neg, const FP* block_center_pos, const int stride2,
    const FP* block_pos_pos, const FP* block_pos_neg, 
...
ATTRIBUTE FP cross_deriv_center_neg(
    const FP* block, const size_t base_idx,
    const size_t dir1, const FP* block_neg_center, const FP* block_pos_center, const int stride1,
    const size_t dir2, const FP* block_center_neg, const FP* block_center_pos, const int stride2,
    const FP* block_pos_pos, const FP* block_pos_neg, 
...
ATTRIBUTE FP cross_deriv_center_pos(
    const FP* block, const size_t base_idx,
    const size_t dir1, const FP* block_neg_center, const FP* block_pos_center, const int stride1,
    const size_t dir2, const FP* block_center_neg, const FP* block_center_pos, const int stride2,
    const FP* block_pos_pos, const FP* block_pos_neg, 
...
ATTRIBUTE FP cross_deriv_center_center(
    const FP* block, const size_t base_idx,
    const size_t dir1, const FP* block_neg_center, const FP* block_pos_center, const int stride1,
    const size_t dir2, const FP* block_center_neg, const FP* block_center_pos, const int stride2,
    const FP* block_pos_pos, const FP* block_pos_neg, 
